  ...
  "inline-flex items-center rounded-pill border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        purple: "border-transparent bg-tag-purple text-primary-ink",
        blue: "border-transparent bg-tag-blue text-primary-ink",
        sand: "border-transparent bg-tag-sand text-primary-ink",
        green: "border-transparent bg-tag-green text-primary-ink",
      },
    },
    defaultVariants: {
      variant: "default",
